...
namespace Lab1Weeb
{
    public partial class Forma1 : System.Web.UI.Page
    {
        ...
        void visuKeliones(char[,] map, int[] xDraugu, int[] yDraugu, int[] xSusitikimo, int[] ySusitikimo, int[] xPicerijos, int[] yPicerijos, out int xSus, out int ySus, out int xPic, out int yPic)
        {
        ...
        char[,] readMap(string file, out int x, out int y, out int[] xDraugu, out int[] yDraugu, out int[] xSusitikimo, out int[] ySusitikimo, out int[] xPicerijos, out int[] yPicerijos)
        {
        ...
        bool draugoKelione(int currentX, int currentY, int goalX, int goalY, out int length, char[,] map)
        {
            length = 0;
        ...
        void spausdinimas(char[,] map, int[] xDraugu, int[] yDraugu, int xSus, int ySus, int xPic, int yPic)
        {
