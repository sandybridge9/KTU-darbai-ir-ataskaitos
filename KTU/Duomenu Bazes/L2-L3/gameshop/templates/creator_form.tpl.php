<ul id="pagePath">
	...
	<li><a href="index.php?module=<?php echo $module; ?>&action=list">Zaidimu Kurejai</a></li>
	<li><?php if(!empty($id)) echo "Kurejo redagavimas"; else echo "Naujas kurejas"; ?></li>
</ul>
...
<div id="formContainer">
	...
	<form action="" method="post">
		<fieldset>
			<legend>Kurejo informacija</legend>
			<p>
