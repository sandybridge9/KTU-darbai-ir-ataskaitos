...
('7418829394', 'Aušra', 'Kiseliene', '1965-04-04', '8695959599', ''),
...
--
-- Table structure for table `kontroleriai`
--
...
--
-- Dumping data for table `kontroleriai`
--
...
--
-- Table structure for table `kurejai`
--
...
--
-- Dumping data for table `kurejai`
--

INSERT INTO `kurejai` (`pavadinimas`, `id`) VALUES
('Renegadedei gamess', 1),
('SkynNet games', 2),
('Opium project', 3),
('Syndicate', 4),
('Garfields Box', 5),
...
--
-- Table structure for table `paslaugu_kainos`
--
...
--
-- Dumping data for table `paslaugu_kainos`
--
...
('Cake the Bake', 20, 6),
('Jim the Bin', 21, 7),
('Allister Mallisteres', 23, 1);

-- --------------------------------------------------------

--
-- Table structure for table `rekomenduojami_amziai`
--
...
--
-- Dumping data for table `rekomenduojami_amziai`
--
...
(1, '2017-10-07', '59.99', 4, '4534534534', '4', 8, 4, 4),
(2, '2017-07-07', '47.00', 2, '4564564534', '2', 2, 2, 2),
...
(8, '2017-07-08', '480.00', 4, '6435345965', '8', 8, 2, 2),
...
(1, '2016-02-01', 5, 1, '10.00'),
(2, '2015-08-01', 1, 1, '5.00'),
(3, '2017-07-09', 1, 1, '45.00'),
(3, '2017-07-26', 7, 1, '25.00'),
(4, '2016-02-01', 1, 1, '32.00'),
(4, '2017-07-27', 4, 1, '32.00'),
(5, '2017-07-11', 1, 1, '15.00'),
(5, '2017-07-28', 3, 1, '45.00'),
(6, '2017-07-12', 1, 1, '15.00'),
(6, '2017-07-29', 5, 1, '27.00'),
(7, '2017-07-30', 1, 1, '18.00'),
(7, '2017-07-13', 2, 1, '24.00'),
(8, '2015-08-01', 1, 1, '5.00'),
(9, '2017-07-15', 1, 5, '15.00'),
(10, '2017-07-16', 4, 2, '32.00'),
(11, '2017-07-17', 1, 1, '45.00'),
(12, '2017-07-18', 7, 1, '25.00'),
(13, '2017-07-19', 2, 1, '25.00'),
(14, '2017-07-20', 5, 1, '27.00'),
(15, '2017-07-21', 1, 1, '15.00');
...
CREATE TABLE `zaidimai` (
  ...
  `os` int(11) NOT NULL,
  `rekomenduojamas_amzius` int(11) NOT NULL,
...
INSERT INTO `zaidimai` (`id`, `isleidimo_data`, `multiplayer`, `coop`, `zaideju_skaicius`, `verte`, `zanras`, `kontroleris`, `os`, `rekomenduojamas_amzius`, `stadija`, `fk_projektas`) VALUES
...
--
-- Table structure for table `zaidimu_stadijos`
--
...
--
-- Dumping data for table `zaidimu_stadijos`
--
...
--
ALTER TABLE `uzsakymai`
  MODIFY `nr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- Constraints for table `paslaugu_kainos`
--
ALTER TABLE `paslaugu_kainos`
...
--
-- Constraints for table `zaidimai`
--
ALTER TABLE `zaidimai`
