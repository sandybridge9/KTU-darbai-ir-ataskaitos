...
$required = array('projektas', 'isleidimo_data', 'zanrai', 'kontroleriai', 'os', 'rekomenduojamas_amzius', 'stadija', 'zaideju_skaicius', 'verte');
...
if(!empty($_POST['submit'])) {
	...
	$validations = array (
		...
		'isleidimo_data' => 'date',
		'zanrai' => 'positivenumber',
		'kontroleriai' => 'positivenumber',
		'os' => 'positivenumber',
