...
set newDesign 0
if {![file exists "D:/KTU/SkaitmenineLogika/VHDL(Lab4)/SpecializuotasTestas/SpecializuotasTestas.adf"]} { 
	design create SpecializuotasTestas "D:/KTU/SkaitmenineLogika/VHDL(Lab4)"
  set newDesign 1
}
design open "D:/KTU/SkaitmenineLogika/VHDL(Lab4)/SpecializuotasTestas"
