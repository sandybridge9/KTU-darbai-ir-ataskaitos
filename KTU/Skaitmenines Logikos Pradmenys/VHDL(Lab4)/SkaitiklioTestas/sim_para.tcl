...
set ::bali::simulation::Para(PROJECT) {SkaitiklioTestas}
set ::bali::simulation::Para(PROJECTPATH) {D:/KTU/SkaitmenineLogika/VHDL(Lab4)}
set ::bali::simulation::Para(FILELIST) {"D:/KTU/SkaitmenineLogika/VHDL(Lab4)/Skaitiklis.vhdl" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {counter}
