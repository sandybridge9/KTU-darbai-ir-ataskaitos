...
set ::bali::simulation::Para(PROJECT) {KombinacinesSchemosTestas}
set ::bali::simulation::Para(PROJECTPATH) {D:/KTU/SkaitmenineLogika/VHDL(Lab4)}
set ::bali::simulation::Para(FILELIST) {"D:/KTU/SkaitmenineLogika/VHDL(Lab4)/KombinacineSchema.vhdl" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {decoder}
