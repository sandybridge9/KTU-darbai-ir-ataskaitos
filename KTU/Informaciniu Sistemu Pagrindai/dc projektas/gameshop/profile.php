	...
	<body>
		...
		<div class="profile-group">
			<table>
			  ...
			  <tr>
				<td><h3>Profilio aprašymas</h3></td>
			  </tr>
			  <tr>
				<td>Čia yra profilio aprašymas</td>
			  </tr>
			  <tr>
				<td>
				<a href="gamelist.php">Žaidimų sąrašas</a>
				</td>
			  </tr>
			  <tr>
				<td>
				<a href="friendlist.php">Draugų sąrašas</a>
				</td>
			  </tr>
			  <tr>
				<td>
				<a href="picturegalery.php">Nuotraukų galerija</a>
				</td>
			  </tr>
			  <tr>
				<td>
				<a href="reviews.php">Atsiliepimai</a>
				</td>
			  </tr>
			  <tr>
				<td>
				<a href="favoritegames.php">Mėgstamiausi žaidimai</a>
				</td>
			  </tr>
			  <tr>
				<td>
				<a href="achevements.php">Pasiekimai</a>
				</td>
			  </tr>
			</table>
		</div>
